<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Réseau de stations<span class="caret"></span></a>
	<ul class="dropdown-menu" role="menu">
		<li><a href="http://meteo06.fr" target="blank">Portail Météo 06</a></li>
		<li class="divider"></li>
		<li><a href="http://valbonne.meteo06.fr" target="blank">Valbonne</a></li>
		<li><a href="http://cagnes.meteo06.fr" target="blank">Cagnes/Mer</a></li>
		<li><a href="http://nice.meteo06.fr" target="blank">Nice-Pessicart</a></li>
		...
		<li><a href="http://ilonse.meteo06.fr" target="blank">Ilonse</a></li>
		<li class="divider"></li>
		<li><a href="http://nicemeteo.fr" target="blank">Site de l'association</a></li>
		<li class="divider"></li>
		<li><a href="https://www.facebook.com/NiceMeteo/" target="blank">Facebook</a></li>
		<li><a href="https://twitter.com/NiceMeteo06" target="blank">Twitter</a></li>
	</ul>
