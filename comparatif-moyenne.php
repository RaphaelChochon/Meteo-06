...
<html lang="fr-FR" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h1 class="divCenter">Comparatif des méthodes de calcul pour les moyennes de températures</h1>
				<p>Le graphique ci-dessous représente des températures moyennes calculées selon plusieurs méthodes.
					<ul>
