			...
			<?php if (!isset($_GET['more'])) :?>
				<div class="row mb-3">
					<div class="col text-center">
						<a role="button" class="btn btn-primary" href="./records.php?more"><i class="fas fa-chevron-circle-left"></i>&nbsp;Charger plus de records ?</a>
					</div>
				</div>
			<?php else : ?>
				<div class="row mb-3">
					<div class="col text-center">
						<a role="button" class="btn btn-primary" href="./records.php"><i class="fas fa-chevron-circle-left"></i>&nbsp;Charger moins de records ?</a>
					</div>
				</div>
			<?php endif ; ?>
