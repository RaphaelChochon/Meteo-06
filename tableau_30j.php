				...
				<table class="table table-striped table-bordered table-responsive table-hover tabLeft">
					...
					<tbody>
						<tr>
							...
							<td><span class="text-info">Mini</span> <?php echo $minwindchill30j; ?> le <?php echo $minwindchilltime30j; ?></td>
						</tr>
					</tbody>
					<tbody>
						<tr>
							...
							<td><span class="text-danger">Maxi</span> <?php echo $maxheatindex30j; ?> le <?php echo $maxheatindextime30j; ?></td>
						</tr>
					</tbody>
				</table>
			</div>
